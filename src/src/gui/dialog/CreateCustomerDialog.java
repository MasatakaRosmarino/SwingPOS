...
public class CreateCustomerDialog extends BaseDialog{
    ...
    public CreateCustomerDialog(CustomerGUIListener customerGUIListener, CustomerContactGUIListener customerContactGUIListener){
    	super();
    	
        setTitle("Create new Customer and Contact");
        ...
        saveButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                customerGUIForm = new CustomerGUIForm(name, lastname, gender, idNumber, birthdate);
                ...
                if (name.isEmpty() || lastname.isEmpty() || idNumber.isEmpty() || phone.isEmpty() || email.isEmpty() || address.isEmpty() || zipCode.isEmpty() || city.isEmpty() || province.isEmpty() || country.isEmpty()) {
                    ...
                    customerContactGUIListener.guiTableRowSaved(contactGUIForm);

                    //inserting newly-created ids into shop_user_contact
                    int[] contactIDs = customerContactGUIListener.newRowsIdsRetrieved();

                    customerContactGUIListener.customerRelationalIdsInserted(contactIDs[0], contactIDs[1]);
                }
