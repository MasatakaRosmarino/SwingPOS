    ...
    public void saveDatabaseTableRow(ProductGUIForm productGUIForm) {
        ...
        try {
            if (productGUIForm.getFormIdField() == null || productGUIForm.getFormIdField().isEmpty()) {
                ...
                product = new Product(Integer.parseInt(productGUIForm.getFormIdField()), productGUIForm.getProductName(), productGUIForm.getProductDescription(), Double.parseDouble(productGUIForm.getAcquisitionPrice()), Double.parseDouble(productGUIForm.getSellingPrice()), Integer.valueOf(productGUIForm.getProductItemsPerUnit()), ProductCondition.valueOf(Utilities.convertStringToEnum(productGUIForm.getProductCondition())), null, Integer.valueOf(productGUIForm.getProductCategoryId()), Integer.valueOf(productGUIForm.getSupplierId()), 0);
            }
